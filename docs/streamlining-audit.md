...
### STR-01: Three Identical ODF Helper Implementations
...
### STR-02: ALLOWED_EXTENSIONS vs SUPPORTED_EXTENSIONS Maintained Separately
...
### STR-03: _db_write_with_retry Only Available in bulk_worker.py
...
### STR-04: SearchIndexer() Instantiated Directly Instead of Using Singleton
...
### STR-05: database.py Is 1,800+ Lines Covering 10+ Domains
...
### STR-06: _now_iso() Defined Four Times
...
### STR-07: media_exts Set Defined Inline in bulk_worker.py
...
### STR-08: _verify_source_mount Duplicated Between Scanners
...
### STR-09: asyncio Imported Inside Function Bodies 4 Times in lifecycle_scanner.py
...
### STR-10: Deferred get_preference Imports in Every Scheduler Function
...
### STR-11: record_activity_event Import-Guarded in 6 Files
...
### STR-12: get_search_indexer() Fetched Twice Per Conversion in bulk_worker.py
...
### STR-13: upsert_source_file Uses SELECT-then-INSERT/UPDATE Instead of SQLite UPSERT
...
### STR-14: upsert_adobe_index Has Same SELECT-then-INSERT Pattern
- **File:** core/database.py:1276-1314
- **Category:** Inefficient patterns
- **Description:** Same as STR-13. Hot path during Adobe indexing runs.

### STR-15: Repeated Optional-Filter Query Pattern in database.py (6 Functions)
...
### STR-16: formatDate and formatLocalTime Overlap in app.js
...
### STR-17: init_db() Has 40+ _add_column_if_missing Calls
...
### STR-18: import os Inside _fire_webhook Function Body
...
### STR-19: Unused aiosqlite Import in auto_converter.py
...
### STR-20: logger vs log Naming Inconsistency
...
### STR-21: cleanup_orphaned_jobs Creates Its Own Logger
...
### STR-22: is_file_flagged() and _sync_is_flagged() Run Same Query
...
### STR-23: GROUP BY Status Pattern Repeated 3 Times
...
### STR-24: API Error Extraction Duplicated 4 Times in app.js
