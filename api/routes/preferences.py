...
_SYSTEM_PREF_KEYS: set[str] = {
    ...
    "cloud_prefetch_enabled", "cloud_prefetch_concurrency", "cloud_prefetch_rate_limit",
    "cloud_prefetch_timeout_seconds", "cloud_prefetch_min_size_bytes", "cloud_prefetch_probe_all",
...
_PREFERENCE_SCHEMA: dict[str, dict] = {
    ...
    # ── Cloud prefetch (v0.15.1) ──
    "cloud_prefetch_enabled": {
        "type": "toggle",
        "label": "Enable cloud prefetch",
        "description": "Pre-fetch files from network shares before scanning to reduce per-file stall time.",
        "section": "cloud_prefetch",
    },
    "cloud_prefetch_concurrency": {
        ...
        "max": 50,
        "label": "Concurrency",
        "description": "Parallel prefetch downloads.",
        "section": "cloud_prefetch",
    },
    "cloud_prefetch_rate_limit": {
        ...
        "min": 1,
        "max": 1000,
        "label": "Rate limit (files/min)",
        "description": "Maximum files fetched per minute.",
        "section": "cloud_prefetch",
    },
    "cloud_prefetch_timeout_seconds": {
        ...
        "min": 10,
        "max": 3600,
        "label": "Per-file timeout (seconds)",
        "description": "Abort prefetch of a single file after this many seconds.",
        "section": "cloud_prefetch",
    },
    "cloud_prefetch_min_size_bytes": {
        ...
        "description": "Files smaller than this are skipped. 0 = prefetch all sizes.",
        "section": "cloud_prefetch",
    },
    "cloud_prefetch_probe_all": {
        "type": "toggle",
        "label": "Probe all files",
        "description": "Check every file for cloud-only status, not just files the OS flags as offline.",
        "section": "cloud_prefetch",
    },
}
