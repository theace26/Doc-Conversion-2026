...
__all__ = [
    ...
    "create_exclusion", "get_exclusion", "list_exclusions",
    "update_exclusion", "delete_exclusion", "get_exclusion_paths",
    ...
    "get_ai_assist_provider", "set_ai_assist_provider",
