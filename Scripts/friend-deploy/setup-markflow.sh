...
# ══════════════════════════════════════════════════════════════
#  3. GPU Detection (macOS)
# ══════════════════════════════════════════════════════════════
echo ""
echo -e "${YELLOW}[3/6] Detecting GPU and hashcat...${NC}"
...
# ══════════════════════════════════════════════════════════════
echo ""
echo -e "${YELLOW}[4/6] Writing .env configuration...${NC}"
...
# ══════════════════════════════════════════════════════════════
echo ""
echo -e "${YELLOW}[5/6] Preparing Docker environment...${NC}"
...
# ══════════════════════════════════════════════════════════════
echo ""
echo -e "${YELLOW}[6/6] Building and starting MarkFlow...${NC}"
